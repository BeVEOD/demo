...
## It should be placed at 'test/unit/translation_test.rb'
...
class TranslationTest < ActiveSupport::TestCase
  ...
  test "Active Filter" do
    ...
    Translation::COMPARATORS.each do |f, h|
      val = case Translation::FIELDS[f]
      ...
      ops.select{|op| Translation::COMPARATORS[f][op] }.each { |op|
        assert_not_nil(Translation.active_filter({f => {op => val}}))
      }
    end
  end
